...
public class QuizQuestionTable {
	...
	public static final String TABLE_CREATE_STATEMENT = "CREATE TABLE "
			...
			+ COLUMN_QUESTION_ID + " INTEGER NOT NULL, " + COLUMN_QUIZ_POSITION
			+ " INTEGER NOT NULL, " + "FOREIGN KEY (" + COLUMN_ID
			+ ") REFERENCES " + QuizTable.TABLE_NAME + "("
			+ QuizTable.COLUMN_ID + "), " + "FOREIGN KEY ("
