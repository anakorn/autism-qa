...
public class AnswerTable {
	...
	public static final String TABLE_CREATE_STATEMENT = "CREATE TABLE "
			...
			+ " INTEGER PRIMARY KEY AUTOINCREMENT , " + COLUMN_QUESTION_ID
			+ " TEXT NOT NULL, " + COLUMN_CREATE_TIMESTAMP + " TEXT NOT NULL, "
			+ COLUMN_RESPONSE_TIME + " REAL NOT NULL, " + COLUMN_ANSWER_VALUE
			+ " INT NOT NULL, " + "FOREIGN KEY (" + COLUMN_QUESTION_ID
			+ ") REFERENCES " + QuestionTable.TABLE_NAME + ");";
}
